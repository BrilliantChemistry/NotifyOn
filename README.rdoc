...
The primary goal of the project is to provide a unified DSL for

1. ActiveRecord callbacks that perform an action with if :state1 elsif :state2 are error prone and cumbersome. Difficult to test and verbose.
